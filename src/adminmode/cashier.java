...
//    } 
        ...
        try {
            String sqlupdate = "SELECT id,nationalID,name,username FROM Cashier ";
            pst = conn.prepareStatement(sqlupdate);
            rs = pst.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //id1 = txtID.getText();
            ...
            try {
                pst = conn.prepareStatement("UPDATE Cashier SET nationalID=?,name=?,username=?,password=? WHERE id=?");

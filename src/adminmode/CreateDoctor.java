...
//    } 
    ...
    private void initComponents() {
        ...
        UpdateTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doc ID", "National ID", "Name", "User Name"
            }
        ) {
        ...
        lblId.setFont(new java.awt.Font("Microsoft JhengHei UI", 1, 14)); // NOI18N
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(txtNationalID, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
        ...
        try {
            ...
            try {
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "Cannot save duplicate national Id!");
                }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //id1 = txtID.getText();
            ...
            try {
                pst = conn.prepareStatement("UPDATE Doctor SET nationalID=?,name=?,username=?,password=? WHERE id=?");
